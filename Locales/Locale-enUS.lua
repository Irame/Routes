...
L["Now running CETSP in the background..."] = true
L["There is already a TSP running in background. Wait for it to complete first."] = true
L["There is already a TSP/CETSP running in background. Wait for it to complete first."] = true
L["Stage %d - Pass %d: %d%% - %d yards"] = true
L["Stage %d - Pass %d: %d%%"] = true
